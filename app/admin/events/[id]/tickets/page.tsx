...
export default function TicketDashboardPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingTicketId) {
        // Update existing ticket - use multipart form field format for attendees
        ...
        // Create new ticket using the public endpoint with multipart format
        if (!payslipFile) {
          throw new Error('Payslip is required for new tickets');
        }
        ...
        const response = await authFetch(`/api/v1/public/events/${eventId}/purchase`, {
          method: 'POST',
          body: formDataToSend,
        });
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent text-black file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:font-semibold file:bg-[var(--color-primary)] file:text-black hover:file:bg-[#45B8E5]"
                  />
                  {editingTicketId && (
                ...
                {formData.attendees.map((attendee, index) => (
                  <div key={index} className="flex items-center gap-2 mb-2">
                    <input
                      ...
                      required
                      className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent text-black"
                    />
